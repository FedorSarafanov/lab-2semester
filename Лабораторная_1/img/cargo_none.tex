...
\begin{document}
	\begin{tikzpicture}
		...
		anchor=north west,draw=none,inner sep=0pt,fill=gray!10}
	        ...
	        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_none_1.dat};
	        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_none_2.dat};
	        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_none_3.dat};
	    \end{axis}
	\end{tikzpicture}	
