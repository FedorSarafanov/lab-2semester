...
\begin{document}
	\begin{tikzpicture}
        ...
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_start_1.dat};
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_start_2.dat};
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_start_3.dat};
	    \end{axis}
	\end{tikzpicture}	
