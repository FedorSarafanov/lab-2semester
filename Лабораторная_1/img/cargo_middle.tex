...
\begin{document}
	\begin{tikzpicture}
		...
		anchor=north west,draw=none,inner sep=0pt,fill=gray!10}
			...
			\addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_middle_1.dat};
			\addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_middle_2.dat};
			\addplot +[thin, x=t, y=x, smooth, mark=] table[x expr=\thisrowno{0}+0.1] {../data/cargo_middle_2.dat};
	    \end{axis}
	\end{tikzpicture}	
