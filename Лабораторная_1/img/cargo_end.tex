...
\begin{document}
	\begin{tikzpicture}
        ...
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_end_1.dat};
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_end_2.dat};
        \addplot +[thin, x=t, y=x, smooth, mark=] table {../data/cargo_end_3.dat};
	    \end{axis}
	\end{tikzpicture}	
